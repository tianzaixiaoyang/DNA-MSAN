...
def read_train_test(input_path, split):
    ...
    evalne.utils.split_train_test.store_train_test_splits :
     ...
     """
    # Generate file names
    filenames = (os.path.join(input_path, "trE_{}_{}.csv".format(split, config.lp_train_frac)),
                 os.path.join(input_path, "negTrE_{}_{}.csv".format(split, config.lp_train_frac)),
                 os.path.join(input_path, "teE_{}_{}.csv".format(split, config.lp_train_frac)),
                 os.path.join(input_path, "negTeE_{}_{}.csv".format(split, config.lp_train_frac)))
